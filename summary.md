...
- 최신 캡처에서는 객석 참가자가 무선 마이크로 질문/의견을 말하는 장면이 포착됐지만, 해당 구간 STT는 비어 있어 세부 질문 내용은 확인되지 않았다.
...
- 최신 STT 청크 259~261은 비어 있어 추가 음성 정보는 확인되지 않았다.
...
- 최신 캡처에서는 객석 참가자가 무선 마이크로 질문하는 장면이 확인됐지만, 259~261 청크 STT는 비어 있어 질문 내용은 아직 확인되지 않았다.
