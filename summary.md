...
- 이후 방송은 대기시간 화면이 더 길게 이어진 뒤 MC 김효진 아나운서 진행으로 다시 전환되었고, 새 대형 콘텐츠보다 기존 콘텐츠와 생활 요소를 먼저 살려 달라는 질문과 7월 레시피 추가·편의성 개선 방향이 이어졌다. 이어 교역·바운티헌터 접근성 문제와 교역·생활시즌을 6개월로 묶는 구조 재검토가 논의됐고, 밀수 개선안과 채집용 단검 우선순위 문제도 이어졌다. 171~176번은 무음이었고 177~195번에서 새 질문들이 이어졌다.
...
- 171~176번은 무음이었고, 177~180번에서 생활/기존 콘텐츠 개선 질문이 이어진 뒤 181~195번에서 교역/바운티헌터 접근성, 시즌 구조, 밀수 개선, 채집용 단검 질문이 이어졌다.
...
- 2부는 현재도 진행 중이며, 방송 재개 전 대기시간 화면이 더 길게 이어진 뒤 MC 김효진 아나운서 진행으로 전환됐고, 새 대형 콘텐츠보다 기존 콘텐츠와 생활 요소를 먼저 살려 달라는 요청과 7월 레시피 추가·편의성 개선 방향이 이어졌다. 이어 교역·바운티헌터 접근성 문제와 교역·생활시즌을 6개월로 묶는 구조 재검토가 논의됐고, 밀수 개선안과 채집용 단검 우선순위 문제도 이어졌다. 171~176번은 무음이었고 177~195번에서 새 질문들이 이어졌다.
