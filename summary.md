...
- 이후 방송은 대기시간 화면이 더 길게 이어진 뒤 MC 김효진 아나운서 진행으로 다시 전환되었고, 새 대형 콘텐츠보다 기존 콘텐츠와 생활 요소를 먼저 살려 달라는 질문과 7월 레시피 추가·편의성 개선 방향이 이어졌다. 이어 교역·바운티헌터 접근성 문제와 시즌 구조 재검토가 논의됐다. 171~176번은 무음이었고 177~186번에서 새 질문들이 이어졌다.
...
| 02:03~02:07 | 음성/Q&A | 질문 주제: 교역 중 약탈단 조우와 바운티헌터(현상금 사냥권) 접근성 → 필리아까지 가도 약탈단을 못 만난다는 문제와 현상금 사냥 구조가 현재 교역 환경에 맞지 않는다는 지적이 나왔다. 답변: 바운티헌터 부분은 수정이 필요하다고 보고, 교역은 한 차례 개편했지만 추가 개편이 필요하며 빠른 수정은 어렵더라도 근본 수정은 교역 개선 과정에서 함께 진행하겠다고 설명했다. 교역과 생활을 시즌으로 묶는 구조도 재검토하겠다고 언급 | `videos/lSX4UvPFIZM/transcripts/chunk_000181.txt`~`videos/lSX4UvPFIZM/transcripts/chunk_000186.txt` |
...
| 교역·바운티헌터 접근성 | 교역 중 약탈단 조우와 현상금 사냥권 구조가 현재 서버 환경과 맞지 않는다는 문제 | 바운티헌터 부분은 수정이 필요하고, 교역은 한 차례 개편했지만 추가 개편이 필요하며 빠른 수정은 어렵더라도 교역 개선 과정에서 근본 수정과 시즌 구조 재검토를 함께 하겠다고 답했다 | `videos/lSX4UvPFIZM/transcripts/chunk_000181.txt`~`videos/lSX4UvPFIZM/transcripts/chunk_000186.txt` |
...
- 171~176번은 무음이었고, 177~180번에서 생활/기존 콘텐츠 개선 질문이 이어진 뒤 181~186번에서 교역/바운티헌터 접근성 질문이 이어졌다.
...
- 2부는 현재도 진행 중이며, 방송 재개 전 대기시간 화면이 더 길게 이어진 뒤 MC 김효진 아나운서 진행으로 전환됐고, 새 대형 콘텐츠보다 기존 콘텐츠와 생활 요소를 먼저 살려 달라는 요청과 7월 레시피 추가·편의성 개선 방향이 이어졌다. 이어 교역·바운티헌터 접근성 문제와 시즌 구조 재검토가 논의됐다. 171~176번은 무음이었고 177~186번에서 새 질문들이 이어졌다.
