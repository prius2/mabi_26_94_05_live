...
- 최신 캡처 1441은 ON AIR 패널 토크 화면으로 재개된 상태이고, 1427은 00:45 카운트다운이 보이는 마비노기 커넥트 LIVE 대기 화면이었다.
...
- 휴식 직후에는 카운트다운 대기 화면(frame_001427)이, 재개 후에는 ON AIR 패널 화면(frame_001441)이 확인됐다.
